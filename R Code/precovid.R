...
dir <- "C:/Users/wiinu/OneDrive - cchmc/Documents/AHLS/Precovid Predictions/"
...
asthma_precovid <- bind_rows(as_tibble(arima_predict), as_tibble(ets_predict), as_tibble(prophet_predict))
asthma_precovid
...
plot.roc(arima.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         main="ROC from ARIMA(3,0,1)(0,0,1)[7] (HIGH=5)")
