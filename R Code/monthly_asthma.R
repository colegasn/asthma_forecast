...
dir <- "C:/Users/wiinu/OneDrive - cchmc/Documents/AHLS/Predictions/Monthly Predictions/"
...
# Save the predictions
dir <- "C:/Users/wiinu/OneDrive - cchmc/Documents/AHLS/Predictions/Monthly Predictions/"
# saveRDS(asthma_predict, paste(dir, "monthly_predict.rds", sep=""))
...
# Read in the monthly rolling predictions
asthma_predict <- readRDS(paste(dir, "monthly_predict.rds", sep=""))
asthma_predict
...
plot_predict <- asthma_predict |>
  ...
  scale_x_date(name="Date", date_breaks = "1 months", date_labels = "%b %Y",
               ...
               expand = c(0,0))+
  scale_y_continuous(name="Hospitalizations", breaks = seq(-20,300,by=40))+
  theme_bw()+
...
plot.roc(arima.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         main="ROC from ARIMA(0,1,2)(1,0,2)[7] (HIGH=137)")
...
plot.roc(ets.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         identity.lty="dashed", identity.col="black",
         print.auc=TRUE, auc.polygon = TRUE, 
         main="ROC from ETS(A,N,A) (HIGH=137)")
...
plot.roc(prophet.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         identity.lty="dashed", identity.col="black",
         print.auc=TRUE, auc.polygon = TRUE, 
         main="ROC from Prophet (HIGH=137)")
