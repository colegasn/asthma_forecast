...
# Save the predictions
dir <- "C:/Users/wiinu/OneDrive - cchmc/Documents/AHLS/Predictions/Weekly Predictions/"
# saveRDS(asthma_predict, paste(dir, "weekly_predict.rds", sep=""))
...
# Read in the weekly rolling predictions
asthma_predict <- readRDS(paste(dir, "weekly_predict.rds", sep=""))
asthma_predict
...
plot.roc(arima.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         main="ROC from ARIMA(0,1,2)(1,0,2)[7] (HIGH=34)")
...
plot.roc(ets.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         identity.lty="dashed", identity.col="black",
         print.auc=TRUE, auc.polygon = TRUE, 
         main="ROC from ETS(A,N,A) (HIGH=34)")
...
plot.roc(ensemble.roc, col="red", lwd=2.5, print.thres=TRUE,
         ...
         identity.lty="dashed", identity.col="black",
         print.auc=TRUE, auc.polygon = TRUE, 
         main="ROC from Ensemble Model (HIGH=34)")
